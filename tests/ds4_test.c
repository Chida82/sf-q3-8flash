...
static ds4_engine *test_open_engine(bool quality) {
    ...
    /* sf-ablate(specdec): DS4_TEST_MTP loaded an external MTP head; this child
     * has no external support model. Built-in Qwen MTP is driven by
     * DS4_TEST_GLM_MTP below. */
