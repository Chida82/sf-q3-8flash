...
| #1056 | Metal: optimize Qwen3.8 kernels, MTP state and SSD MoE scheduling | open | `b1af94b` | 30 | 2026-09-23 | 2026-09-24 | `40` took the HC reuse only (plain decode +0.8%; Q8 commits measured and dropped), MTP ideas -> `30`, `13c53d9`'s shared Q8 loop -> `50` (plain decode +1.3%), SSD -> `80`, IQ2/Q2_K -> `70`; chunk-invariant prefill dropped |
